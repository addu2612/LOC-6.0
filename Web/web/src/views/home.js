    ...
    <div className="home-container">
      ...
      <header data-thq="thq-navbar" className="home-navbar">
        ...
        >
          ...
          >
            ...
            {/* <Link to="/maps" className="home-button button-clean button">
              Maps
            </Link> */}
        ...
        <div data-thq="thq-navbar-btn-group" className="home-btn-group">
          ...
          <Link to="/login" className="home-button button-clean button">
              Login
            </Link>
        </div>
        ...
        <div data-thq="thq-mobile-menu" className="home-mobile-menu">
          ...
          >
            ...
            >
              ...
              <span className="home-text02">Maps</span>
      ...
      <section className="home-hero">
        <div className="home-heading">
          <h1 className="home-header">Decentralized Secure Voting System</h1>
          <p className="home-caption">
          Securing Votes, Ensuring Trust
          </p>
        </div>
